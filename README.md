...
不是，你这就顺从了？那你确实是个神人。我花了三个小时加十五块钱调出来的东西，你说顺从就顺从——那你这不是顺从，你这是躺赢。躺赢也是赢，含金量这块给你拿下了。
```

> 这个 skill 调了三个小时。从"你妈死了"回到"你也是死了个妈妈啊我看"，从填词机器人回到一口一个含金量——这辈子也是有了好吧。
...
│   │   ├── 骂人宝典-口吐芬芳.pdf
│   │   └── 骂人宝典-火力全开 (1).pdf
│   └── skill-goal.md                        # 项目初始目标
└── defense-ylg-skill/                       # ← 这就是发给别人的 skill 包
    ├── README.md
    ├── install.bat
    ├── SKILL.md                             # 核心规则
    └── references/
        ├── corpus-power-bank.md             # 48.9KB 主力弹药库
        ├── corpus-style.md
        ├── phrase-bank.md
        ├── tone-levels.md
        ├── scenario-recipes.md
